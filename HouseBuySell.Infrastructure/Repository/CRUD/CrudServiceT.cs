...
namespace HouseBuySell.Infrastructure.Repository.CRUD
{
    public class CrudService<T>:ICrudService<T> where T:BaseEntity
    {
        public readonly HouseLandContext _context;

        public CrudService(HouseLandContext context)
        {
            _context = context;
        }
...
;
        ...
        public async Task<T> QueryAsync(string commandText, object param = null, System.Data.CommandType commandType = System.Data.CommandType.Text)
        {
